SELECT
    ...
    -- Segmentação por faixa de idade
    CASE
    ...
    -- Segmentação por presença de pelo menos 1 sintoma
    CASE
    ...
    -- Segmentação por presença de pelo menos 1 doença
    CASE
    ...
    -- Segmentação por resultados positivos e negativos
    CASE
    ...
    -- Levantamento quantitativo das caracteristicas
